...
# SE.2.0_NUM_HH_EXP - total monthly expenditure 
...
df_hh <- df_hh %>%
  mutate(across(c(SE.2.1_NUM_FOOD, SE.2.2_NUM_ACCOM,SE.2.3_NUM_HLTH, SE.2.4_NUM_HYG, SE.2.5_NUM_COMM, SE.2.6_NUM_HH_BILL, SE.2.7_NUM_OTH, SE.2.8_NUM_HLTH_6_MTH, SE.2.9_NUM_DEBT, SE.2.10_NUM_EDU), ~ replace(., . %in% c(9999,99999), NA)))
