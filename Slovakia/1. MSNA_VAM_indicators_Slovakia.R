...
rm(list = ls())
setwd("/Users/irmasirutyte/Desktop/MSNA Composite/MSNA_updated_slovakia")
...
sheet_names = excel_sheets("Data/slovakia_msna_2023_cleandata.xlsx") # get sheet names
sheet_names # print sheet names

# Read Sheet 1
df_hh <- read_excel("Data/slovakia_msna_2023_cleandata.xlsx", sheet = "Slovakia_MSNA_2023")
# View(df_hh)
...
write.xlsx(df_hh_export, "VAM/hh_indicators_slovakia.xlsx")


df_ind_export <- df_ind %>%
  select("_index","_parent_index","disability") 

write.xlsx(df_ind_export, "VAM/ind_indicators_slovakia.xlsx")
